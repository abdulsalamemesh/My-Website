        ...
        <nav
            ...
            <div class="flex justify-between items-center w-full">
                <form @submit.prevent="logout" class="hidden md:block w-full">
                    <button type="submit"
                        class="w-full py-2.5 px-3 text-black dark:text-slate-200 text-sm font-medium hover:text-white dark:hover:text-indigo-500 hover:bg-blue-500 dark:hover:bg-slate-800 hover:transition hover:delay-75 hover:duration-300 text-center whitespace-nowrap">
                        Log Out
                    </button>
                </form>
            ...
            <nav v-show="showNav"
                ...
                <div class="grow flex flex-col justify-center items-center space-y-2 ">
                    ...
                    <form @submit.prevent="logout">
                        <button type="submit"
                            class="py-2.5 px-3 text-black dark:text-slate-200 font-medium hover:text-blue-500 dark:hover:text-indigo-500 transition-all delay-75 duration-300 text-center whitespace-nowrap">
                            Log Out
                        </button>
                    </form>
                </div>

...
<template>
    <div class="h-screen font-montserrat flex flex-col md:flex-row relative">
        ...
        <nav
            ...
            <div class="hidden md:flex justify-between space-x-4">
                <button @click="toggleDark()">
                    <template v-if="isDark">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            class="h-6 w-6 text-white hover:text-indigo-600 transition-all delay-75 duration-300 fill-current">
                            <path
                    ...
                    <template v-else>
                        <!--Moon-->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            class="h-6 w-6 text-black hover:text-blue-500 transition-all delay-75 duration-300 fill-current">
                            <path
                ...
                <template v-if="selectableLocale === 'de'">
                    <svg viewBox="0 0 512 512" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex justify-between items-center w-full md:hidden">
                <div class="flex justify-center items-center md:hidden">
                    <button class="p-3" @click="toggleDark()">
                        <template v-if="isDark">
                            <!--Sun-->
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                    ...
                    <Link :href="route('language', [selectableLocale])" class="rounded-full p-3" preserve-scroll>
                    <template v-if="selectableLocale === 'de'">
                        <svg viewBox="0 0 512 512" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="256" cy="256" r="256" fill="#F0F0F0" />
                            <g fill="#0052B4">
                                <path
                ...
                <button @click="showNav = !showNav" class="p-3 md:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                        class="h-7 w-7 text-blue-500 dark:text-indigo-600 fill-current">
                        <path
        ...
        <!--Mobile Menu-->
        <transition enter-active-class="transition-all ease-in-out duration-500" enter-from-class="transform opacity-0 "
            enter-to-class="transform opacity-100" leave-active-class="transition-all ease-in-out duration-150"
            leave-from-class="transform opacity-100 " leave-to-class="transform opacity-0 ">
            <nav v-show="showNav"
                class="bg-slate-50 dark:bg-slate-900 md:hidden pb-1 absolute inset-0 z-50 flex flex-col justify-between items-center md:hidden">
                <!--Mobile Buttons-->
                <div class="flex justify-end w-full">
                    <button @click="showNav = !showNav" class="p-3 md:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"
                            class="h-6 w-6 text-blue-500 dark:text-indigo-600 fill-current">
                            <path
        ...
        <!--Content-->
        <main class="grow overflow-y-auto scroll-smooth scrollbar bg-slate-50 dark:bg-slate-900" id="content"
            @click="showNav = false">
            <!-- Page Content -->
            <slot />
